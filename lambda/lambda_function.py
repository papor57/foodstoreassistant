...
# papor papor
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to the food Assistant"
...
class FoodRequestIntentHandler(AbstractRequestHandler):
    ...
    #def handle(self, handler_input):   
        ...
        #event.request.intent.slots.recipe.value
        
        foodtype = slots["foodtype"].value
        
        if foodtype == "bananas" or foodtype == "banana":
            speak_output = "yes we do offer bananas"
            
        elif foodtype == "pasta" :
            speak_output = " No we do not offer pasta "
